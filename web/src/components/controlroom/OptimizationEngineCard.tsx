      ...
      <div className="flex flex-col justify-between flex-1 gap-3">
        ...
        <div className="space-y-2 text-xs divide-y divide-slate-100">
          ...
          <div className="flex items-center justify-between pt-1">
            <span className="font-mono text-slate-600 flex items-center gap-1.5 text-xs">
              <span>⏱️</span> Solve Time
            </span>
            <div className="flex items-center gap-1 font-digital text-lg font-bold text-slate-900">
          ...
          <div className="flex items-center justify-between pt-1">
            ...
            <div className="font-digital text-lg font-bold text-blue-700">
          ...
          <div className="flex items-center justify-between pt-1">
            ...
            <span className="font-digital text-lg font-bold text-slate-900">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span
                className={`font-digital text-lg font-bold ${
                  conflicts === 0 ? 'text-emerald-600' : 'text-rose-600'
                }`}
              >
                {conflicts} CLASHES
              </span>
        ...
        <div className="p-2 bg-slate-50/80 rounded-xl border border-slate-200/60 flex items-center justify-between text-[10px] font-mono text-slate-500">
